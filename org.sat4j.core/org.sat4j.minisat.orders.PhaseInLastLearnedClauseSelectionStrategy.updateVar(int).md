# Summary
**org.sat4j.minisat.orders.PhaseInLastLearnedClauseSelectionStrategy.updateVar(int)**

This method is **strong pseudo-tested**.
It is covered by 541 test(s). It can be directly accessed from tests methods.
...
## Covering tests
This method is covered by 541 test(s).
