# Summary
**org.sat4j.minisat.restarts.MiniSATRestarts.newConflict()**

This method is **strong pseudo-tested**.
It is covered by 539 test(s). It can be directly accessed from tests methods.
...
## Covering tests
This method is covered by 539 test(s).
