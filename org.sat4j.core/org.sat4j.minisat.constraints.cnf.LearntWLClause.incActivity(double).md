# Summary
**org.sat4j.minisat.constraints.cnf.LearntWLClause.incActivity(double)**

This method is **strong pseudo-tested**.
It is covered by 587 test(s). It can be directly accessed from tests methods.
...
## Covering tests
This method is covered by 587 test(s).
