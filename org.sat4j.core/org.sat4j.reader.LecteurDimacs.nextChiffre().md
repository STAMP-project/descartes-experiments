# Summary
**org.sat4j.reader.LecteurDimacs.nextChiffre()**

This method is **weak pseudo-tested**.
It is covered by 596 test(s). It can not be directly accessed from tests methods.
...
## Covering tests
This method is covered by 596 test(s).
* org.sat4j.BugSAT25.testReaderFromLecteurDimacs() (Distance: 4)
...
* org.sat4j.minisat.TestsFonctionnels.testTrivialInconsistentFormula() (Distance: 6)
