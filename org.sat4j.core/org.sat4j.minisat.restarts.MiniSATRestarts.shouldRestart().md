# Summary
**org.sat4j.minisat.restarts.MiniSATRestarts.shouldRestart()**

This method is **strong pseudo-tested**.
It is covered by 594 test(s). It can be directly accessed from tests methods.
...
## Covering tests
This method is covered by 594 test(s).
