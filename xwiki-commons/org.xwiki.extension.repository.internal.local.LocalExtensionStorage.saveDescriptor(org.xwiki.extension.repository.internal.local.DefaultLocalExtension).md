# Summary
**org.xwiki.extension.repository.internal.local.LocalExtensionStorage.saveDescriptor(org.xwiki.extension.repository.internal.local.DefaultLocalExtension)**

This method is **strong pseudo-tested**.
It is covered by 39 test(s). 
...
## Covering tests
This method is covered by 39 test(s).
