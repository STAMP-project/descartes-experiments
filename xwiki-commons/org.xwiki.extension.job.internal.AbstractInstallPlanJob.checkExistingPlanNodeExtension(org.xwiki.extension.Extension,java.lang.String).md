# Summary
**org.xwiki.extension.job.internal.AbstractInstallPlanJob.checkExistingPlanNodeExtension(org.xwiki.extension.Extension,java.lang.String)**

This method is **strong pseudo-tested**.
It is covered by 47 test(s). 
...
## Covering tests
This method is covered by 47 test(s).
