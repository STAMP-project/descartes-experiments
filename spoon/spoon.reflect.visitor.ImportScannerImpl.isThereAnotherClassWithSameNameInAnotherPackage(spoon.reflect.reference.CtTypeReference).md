# Summary
**spoon.reflect.visitor.ImportScannerImpl.isThereAnotherClassWithSameNameInAnotherPackage(spoon.reflect.reference.CtTypeReference)**

This method is **weak pseudo-tested**.
It is covered by 71 test(s). 
...
## Covering tests
This method is covered by 71 test(s).
