# Summary
**spoon.reflect.visitor.ImportScannerImpl.isTypeInCollision(spoon.reflect.reference.CtReference,boolean)**

This method is **weak pseudo-tested**.
It is covered by 73 test(s). 
...
## Covering tests
This method is covered by 73 test(s).
